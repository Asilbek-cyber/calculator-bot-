...
async def start_command(message:Message):
    ...
    try:
        ...
        await message.answer(text="Assalomu alaykum,sonlarni terishdan oldin pastdagi C xarfini bosing",reply_markup=calculator_button.calculator_builder)
...
async def help_commands(message:Message):
    await message.answer("Bu kalkulyator boti siz bu bot orqali uzingizga kerakli amallar javobini chiqarib oling")
...
async def about_commands(message:Message):
    await message.answer("Men Abdalimov  Asilbek SIFAT oquv markazining uquvchisiman\nushbu botni 2024-yil 18-mart sanasida yaratdim")
